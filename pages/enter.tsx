        ...
        <div className="mt-16 px-4">
            ...
            <div className="mt-9">
                <div className="flex flex-col items-center">
                    ...
                    <div className="grid border-b w-full mt-7 grid-cols-2">
                        <button onClick={onEmailClick} className={className("pb-4 box-border border-b-2 font-medium focus:outline-none", method === "email" ? " border-orange-400 text-orange-500" : "border-transparent text-zinc-600")}>이메일 주소</button>
                ...
                <div className="mt-8">
                    ...
                    <div className="grid grid-cols-2 gap-3 mt-2">
                        <button className="flex justify-center items-center py-2 px-4 border border-gray-300 rounded shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50">
                            <svg
                                className="w-5 h-5"
                                aria-hidden="true"
                                fill="currentColor"
