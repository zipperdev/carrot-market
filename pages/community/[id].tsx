    ...
    return (
        <div>
            ...
            <div className="px-4">
                ...
                />
                <button className="mt-2.5 w-full bg-orange-500 hover:bg-orange-600 text-white py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium transition focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500">답변하기</button>
            </div>
        </div>
    );
};
